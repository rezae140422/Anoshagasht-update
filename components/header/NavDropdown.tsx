...
export default function NavDropdown({ 
  ...
  const mobileStyles = isMobile ? {
    /* removed border so mobile dropdowns don't show separator lines */
    wrapper: "pb-2",
  ...
  /* removed border on dropdown panel to avoid visible outline */
  content: "absolute top-full left-0 mt-1 w-64 bg-black/90 rounded-xl overflow-hidden backdrop-blur-xl shadow-xl p-3 animate-fadeIn",
